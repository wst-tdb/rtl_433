...
static int hcs200_callback(r_device *decoder, bitbuffer_t *bitbuffer)
{
    ...
    data_t *data = data_make(
            ...
            "button_num",       "Button",       DATA_INT,       btn_num,
            "button3",          "Button S3",    DATA_COND, !learn, DATA_INT, (btn & 0x08) != 0,
            "button0",          "Button S0",    DATA_COND, !learn, DATA_INT, (btn & 0x04) != 0,
            "button1",          "Button S1",    DATA_COND, !learn, DATA_INT, (btn & 0x02) != 0,
            "button2",          "Button S2",    DATA_COND, !learn, DATA_INT, (btn & 0x01) != 0,
